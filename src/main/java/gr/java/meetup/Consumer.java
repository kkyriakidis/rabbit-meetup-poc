 ...
 * Topic uri:
 * rabbitmq://localhost/testTopic?queue=kosmas&exchangeType=topic&routingKey=kosmas.*
 * rabbitmq://localhost/testTopic?queue=spyros&exchangeType=topic&routingKey=spyros.*
 * rabbitmq://localhost/testTopic?queue=pizza&exchangeType=topic&routingKey=*.pizza
 */
